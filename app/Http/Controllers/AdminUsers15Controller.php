<?php namespace App\Http\Controllers;
	...
	class AdminUsers15Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Maxspace","name"=>"maxspace"];
			...
			$this->form[] = ['label'=>'Maxspace','name'=>'maxspace','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Usedspace','name'=>'usedspace','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Maxspace","name"=>"maxspace","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Usedspace","name"=>"usedspace","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
